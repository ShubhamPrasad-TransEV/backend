...
export class AnalyticsService {
  ...
  async getSellerAnalytics(
    ...
    const analyticsMap = {
      monthlyRevenue: () =>
        this.getMonthlyRevenue(sellerIdInt, startDate, endDate),
      totalUsers: () =>
        this.getTotalUniqueUsers(sellerIdInt, startDate, endDate),
      percentageOrdersLost: () =>
        this.getPercentageOrdersLost(sellerIdInt, startDate, endDate),
      percentageOrdersGained: () =>
        this.getPercentageOrdersGained(sellerIdInt, startDate, endDate),
      totalProducts: () => this.getTotalProducts(sellerIdInt),
      weeklyOrders: () => this.getWeeklyOrders(sellerIdInt),
      fulfilledOrders: () =>
        this.getFulfilledOrders(sellerIdInt, startDate, endDate),
      recentOrders: () => this.getRecentOrders(sellerIdInt),
      totalRevenue: () => this.getTotalRevenue(sellerIdInt, startDate, endDate),
      averageMonthlyRevenue: () =>
        this.getAverageMonthlyRevenue(sellerIdInt, startDate, endDate),
      totalOrdersFulfilled: () =>
        this.getTotalOrdersFulfilled(sellerIdInt, startDate, endDate),
      totalOrdersCancelled: () =>
        this.getTotalOrdersCancelled(sellerIdInt, startDate, endDate),
      topRevenueGeneratingProduct: () =>
        this.getTopRevenueGeneratingProduct(sellerIdInt, startDate, endDate),
      topSellingProduct: () =>
        this.getTopSellingProduct(sellerIdInt, startDate, endDate),
    };
